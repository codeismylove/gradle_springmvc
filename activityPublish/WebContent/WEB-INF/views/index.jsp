    ...
    <div class="warp">
        ...
        <div class="left_c left">
            ...
            <div class="acc">
                ...
                <div>
                    <a class="one">活动发布系统</a>
                    <ul class="kid">
                        <li><b class="tip"></b><a target="Conframe" href="Template/formstyle.html">首页</a></li>
                        <li><b class="tip"></b><a target="Conframe" href="Template/formstyle.html">活动列表</a></li>
                        <li><b class="tip"></b><a target="Conframe" href="Template/formstyle.html">活动报名</a></li>
                        <li><b class="tip"></b><a target="Conframe" href="Template/formstyle.html">活动报到登记</a></li>
                        <li><b class="tip"></b><a target="Conframe" href="Template/formstyle.html">活动报道</a></li>
                        <li><b class="tip"></b><a target="Conframe" href="Template/formstyle.html">活动评论</a></li>
                    </ul>
                </div>
        ...
        <!--底部开始-->
        <div class="bottom_c">Copyright &copy;个人测试平台(切勿用于商业)</div>
        <!--底部结束-->
    </div>
</body>
</html>
